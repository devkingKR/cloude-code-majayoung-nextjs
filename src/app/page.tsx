    ...
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-12">
        ...
        <div className="space-x-4">
          <Link 
            href="/signup" 
            className="bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 text-white px-8 py-3 rounded-lg font-semibold hover:shadow-lg transform hover:scale-105 transition-all duration-200"
          >
            시작하기
          </Link>
          <Link 
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-12">
        <div className="bg-white p-8 rounded-lg shadow-md">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">자영업자님</h2>
        ...
        <div className="bg-white p-8 rounded-lg shadow-md">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">마케팅 전문가님</h2>
          <p className="text-gray-600 mb-6">
      ...
      <div className="bg-white p-8 rounded-lg shadow-md">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <div className="text-center">
            ...
            <p className="text-gray-600">인스타그램, 페이스북 등 소셜미디어 마케팅</p>
          </div>
          <div className="text-center">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">디지털 광고</h3>
            <p className="text-gray-600">구글, 네이버 광고 운영 및 최적화</p>
          </div>
          <div className="text-center">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">브랜딩</h3>
            <p className="text-gray-600">브랜드 아이덴티티 구축 및 전략 수립</p>
          </div>
        </div>
      </div>
    </div>
